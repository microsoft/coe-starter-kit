...
### Troubleshooting
Common issues and solutions are available in our [troubleshooting guides](docs/troubleshooting/). Check here if you encounter problems with:
- Data collection and inventory
- Flow and app telemetry
