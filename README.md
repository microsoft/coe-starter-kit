...
Having issues with your CoE Starter Kit installation? Check out our [Troubleshooting Guide](TROUBLESHOOTING.md) for help with common problems including:
- Power BI Dashboard not refreshing
- Connector reconnection issues
- Flow failures
