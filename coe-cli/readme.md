...
Looking to contribute or understand how the CLI works? The [CLI](./docs/cli/index.md) discusses how dive technically deeper into the CLI commands and look how to add or extend commands.
